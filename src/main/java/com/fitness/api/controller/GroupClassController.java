...
public class GroupClassController {
     ...
     * @return
     */
    @RequestMapping(value = "/pastGroupClass",method = RequestMethod.GET)
    public BaseResult pastGroupClass(Long stadiumId){
        return groupClassService.pastClass(stadiumId);
    }
